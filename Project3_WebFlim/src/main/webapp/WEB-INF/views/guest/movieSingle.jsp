...
<body>
					...
					<div class="movie-img sticky-sb">
						...
						<div class="movie-btn">
							<div class="btn-transform transform-vertical red">
								<div id="video-play">
									<button class="item redbtn">
										<i class="ion-play"></i> Watch Video
									</button>
								</div>
								<div></div>
							</div>
							<div class="btn-transform transform-vertical" id="buy-ticket">
								<div>
				...
				<div class="popup" id="popup">
					<div class="popup-content">
						...
						<div class="card mt-50 mb-50">
							<div class="card-title mx-auto">Buy ticket</div>
							<div class="nav">
								<ul class="mx-auto">
									<li><a href="#">Nạp tiền</a></li>
									<li class="active"><a href="#">Giao dịch</a></li>
								</ul>
							</div>
							<form>
								<div class="card-div">
									<span id="card-header">Name flim</span>
									<div class="row row-1">
										<p class="name_flim">Đào Phở Piano</p>
									</div>
								</div>
								<div class="card-div">
									<span id="card-header">Name flim</span>
					...
					<div class="movie-single-ct main-content">
						...
						<div class="movie-rate">
							<div class="rate">
								...
								<p>
									<span>8.1</span> /10<br> <span class="rv">56
										Reviews</span>
								</p>
							</div>
							<div class="rate-star">
												...
												<div class="vd-item">
													<div class="vd-it">
														<img class="vd-img" src="images/uploads/vd-item1.jpg"
															...
															href="https://www.youtube.com/watch?v=m00XWbRIMmk"><img
															src="images/uploads/play-vd.png" alt=""></a>
													</div>
													<div class="vd-infor">
														<h6>
	...
	<script src="js/url_watch_video.js"></script>
</body>
</html>